...
export const StudentsView = ({studentData, setStudentInfo}) => {
    return (
        <motion.div initial={{y: -10}} animate={{y: 0}} className='h-screen w-screen z-20 absolute top-0 left-0 grid place-content-center bg-black/45 backdrop-blur-[5px]'>
            <div className='flex flex-col gap-2 rounded-sm outline outline-1 outline-[#212327] w-[350px] h-[500px] md:h-[500px] md:w-[700px] bg-[#1A1B1F]'>
