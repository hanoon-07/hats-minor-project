        ...
        {openHere && (
          ...
          >
            ...
            <div className="h-full w-full flex flex-col justify-end mb-2">
              <button 
                className={`flex flex-row items-center gap-2 p-2 mr-2 rounded-sm text-[#f43f5e] text-lg text-start tracking-tighter hover:bg-[#f43f5e] hover:text-black`}
              >
