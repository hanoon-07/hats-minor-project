...
function AfterSubmissionpage() {
  ...
  useEffect(() => {
    ...
    setFullCase(
      testCaseResult.reduce((acc, curr) => acc + curr, 0) ==
  ...
  useEffect(() => {
    if (loading === 0 && !fullCase) {
        ...
        try {
          const res = await axios.post(
            ...
            },
            {
              headers: {
                Authorization:
                  "Bearer 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",
                "HTTP-Referer": "",
                "X-Title": "",
      ...
      setTimeout(() => {
        navigate("/result", {state: {pop: "not applicable"}});
      }, 3000);
    }
  }, [loading, fullCase]);
    ...
    <div>
      ...
      {!loading && (
        <Popanim
          message={
            fullCase
              ? "Additional test cases are being tested"
